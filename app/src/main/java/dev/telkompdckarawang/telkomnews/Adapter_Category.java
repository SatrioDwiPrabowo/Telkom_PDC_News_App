package dev.telkompdckarawang.telkomnews;

/**
 * Created by ADMIN on 26 Mar 2016.
 */
...
public class Adapter_Category extends ArrayAdapter<ItemAllNews> {
    ...
    public Adapter_Category(Activity act, int resource, List<ItemAllNews> arrayList) {
